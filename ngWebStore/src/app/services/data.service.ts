...
export class DataService {
  ...
  // get discount-trend-sales data
  getLast5DiscountZoneProductSales(data): Observable<any> {
    return this.http.post(this.ADMIN + '/getLast5DiscountZoneProductSales', data)
  }
}
